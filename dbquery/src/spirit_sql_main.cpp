...
//----------------------------------------------------------------------------
struct toysql_grammar : public grammar<toysql_grammar>
{
	template <typename ScannerT>
		struct definition
		{
			definition(toysql_grammar const& self)
			{
				...
				token_t ORDER       = as_lower_d["order"];  
				token_t BY          = as_lower_d["by"];  
				...
				query
					...
					| select_from_where_clause | select_from_order_by_clause ] >> SEMI;
				...
				select_from_order_by_clause
					=  select_from_clause >> order_by_clause ; 
			...
			rule<ScannerT> 
				...
				select_from_where_clause, select_clause, select_from_order_by_clause, 
				table_name, from_clause, var_list_clause, 
				alias_clause, table_alias, alias, 
				where_clause, join_clause, order_by_clause, varname, compare_clause, 
